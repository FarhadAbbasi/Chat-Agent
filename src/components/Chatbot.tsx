...
// import { motion } from "framer-motion";
// import axios from "axios";
// import DocumentUpload from "./components/UploadFile"; // Import the DocumentUpload component
...
//   const [input, setInput] = useState("");
//   const [loading, setLoading] = useState(false);
//   const [showUpload, setShowUpload] = useState(false); // State to toggle upload section
//   const webhookURL = "https://proxpire.com/webhook/personalAssist";
//   const chatEndRef = useRef<HTMLDivElement | null>(null);
...
//         {/* Button to navigate to the file upload section */}
//         <button
...
//         {/* Conditional rendering of the DocumentUpload component */}
